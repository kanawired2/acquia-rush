...
jQuery UI Tooltip library for any themes and modules that require it.

  - jQuery UI [Tooltip documentation](https://jqueryui.com/tooltip/)
  - jQuery UI [Tooltip API
    documentation](https://api.jqueryui.com/tooltip/)
...
2.  Change any references in your theme or module from
    `core/jquery.ui.tooltip` to `jquery_ui_tooltip/tooltip`
